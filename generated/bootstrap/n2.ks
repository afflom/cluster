...
# Kickstart for n2, role compute. The installer substitutes the three
...
# Container graph storage on the sata-ssd. overlay2 and podman's overlay
...
echo 'cluster-health must pass before n2 is in service'
%end
